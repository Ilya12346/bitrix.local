...
<!-- \local\templates\main1\components\bitrix\news.list\catalog_ice_cream\template.php -->
    ...
    <div class="catalog-hero__activity" data-aos="fade-up">
        ...
        <label id='labelTop'  class="catalog-hero__tops desktop" for="top">
            ...
            <div class="catalog-hero__tops-logo"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        fill="#F64653"></path>
                    <path
                        d="M13.511 19.3543L14.0555 21.3864L11.8746 21.9708L13.5878 28.3646L11.3822 28.9556L9.66901 22.5618L7.50056 23.1428L6.95605 21.1107L13.511 19.3543Z"
                        fill="#FFE979"></path>
                    <path
                        d="M23.4804 24.585C22.8591 25.6369 21.8794 26.3421 20.5412 26.7007C19.2029 27.0593 18.0018 26.9384 16.9379 26.3381C15.8739 25.7378 15.1704 24.7974 14.8273 23.517C14.482 22.2284 14.6211 21.0622 15.2446 20.0186C15.8658 18.9668 16.8456 18.2616 18.1838 17.903C19.5303 17.5422 20.7314 17.6631 21.7871 18.2656C22.8488 18.8576 23.5523 19.798 23.8976 21.0866C24.2407 22.3671 24.1016 23.5332 23.4804 24.585ZM20.0066 24.7057C20.7088 24.5176 21.2014 24.1421 21.4844 23.5793C21.7674 23.0165 21.816 22.3881 21.6301 21.6942C21.4419 20.9921 21.0857 20.4722 20.5614 20.1346C20.0349 19.7887 19.4205 19.7098 18.7184 19.898C18.0162 20.0861 17.5236 20.4616 17.2406 21.0244C16.9553 21.5789 16.9068 22.2073 17.0949 22.9094C17.2808 23.6033 17.6371 24.1232 18.1636 24.4691C18.6984 24.8128 19.3127 24.8916 20.0066 24.7057Z"
                        fill="#FFE979"></path>
                    <path
                        d="M26.1021 25.0114L23.8444 16.5855L27.2643 15.6691C28.1482 15.4322 28.9411 15.5164 29.6428 15.9216C30.3424 16.3185 30.8039 16.9341 31.0275 17.7684C31.2489 18.5945 31.1547 19.3502 30.7451 20.0354C30.3333 20.7124 29.6813 21.1704 28.7892 21.4095L27.5872 21.7316L28.3077 24.4204L26.1021 25.0114ZM27.0992 19.9101L27.9542 19.681C28.3259 19.5814 28.5824 19.4152 28.7237 19.1826C28.8711 18.9395 28.9027 18.661 28.8186 18.347C28.7345 18.0331 28.5689 17.8119 28.322 17.6833C28.0728 17.5464 27.7665 17.5266 27.403 17.624L26.548 17.8531L27.0992 19.9101Z"
                        fill="#FFE979"></path>
                </svg></div>
        ...
        <div class="catalog-hero__selects">
            ...
            <div class="catalog-hero__filters mobile" data-popup="catalog-filters">
                <div class="catalog-hero__filters-icon"><svg width="18" height="18" viewbox="0 0 18 18" fill="none"
        ...
        <div class="catalog-hero__reset desktop">
            <div class="catalog-hero__reset-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
...
<section class="catalog-list container section-animation" data-aos="fade-up">
    <div class="catalog-list__inner">
        ...
        <?
			...
			?>
        <a class="catalog-card" href="<?=$arItem["DETAIL_PAGE_URL"]?>" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
            <div class="catalog-card__icons">
                <?if($arItem['PROPERTIES']['is_it_new']['VALUE'] == 'Да'):?>
                ...
                <?endif?>
                <?if($arItem['PROPERTIES']['is_it_cool']['VALUE'] == 'Да'):?>
                <div class="catalog-card__icons-item">
                ...
                <div class="catalog-card__bot">
                    ...
                    <div class="catalog-card__plugs">
                        <div class="catalog-card__plug">
                            ...
                            <div class="catalog-card__plug-text">
                                <?=$arItem['PROPERTIES']['gram']['VALUE']?> г
                            </div>
                            <div data-text=“<?=$arItem['PROPERTIES']['gram']['HINT']?>” class="catalog-card__plug-info">
                        ...
                        <div class="catalog-card__plug">
                            ...
                            <div class="catalog-card__plug-text">
                                <?=$arItem['PROPERTIES']['in_box']['VALUE']?> шт
                            </div>
                            <div data-text=“<?=$arItem['PROPERTIES']['in_box']['HINT']?>”
                                class="catalog-card__plug-info"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewbox="0 0 24 24" fill="none">
                                    <rect x="0.5" y="0.5" width="23" height="23" rx="5.5" fill="white"></rect>
                                    <path
                                        d="M12.75 11C12.75 10.5858 12.4142 10.25 12 10.25C11.5858 10.25 11.25 10.5858 11.25 11V17C11.25 17.4142 11.5858 17.75 12 17.75C12.4142 17.75 12.75 17.4142 12.75 17V11Z"
                        ...
                        <div class="catalog-card__plug">
                            ...
                            <div class="catalog-card__plug-text"><?=$arItem['PROPERTIES']['in_poddon']['VALUE']?> шт
                            </div>
                            <div data-text=“<?=$arItem['PROPERTIES']['in_poddon']['HINT']?>”
                                class="catalog-card__plug-info"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewbox="0 0 24 24" fill="none">
                                    <rect x="0.5" y="0.5" width="23" height="23" rx="5.5" fill="white"></rect>
                                    <path
